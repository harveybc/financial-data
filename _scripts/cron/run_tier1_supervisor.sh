...
PROJECT3_HERMES_SKILLS="${PROJECT3_HERMES_SKILLS:-project3-autonomous-supervisor,project3-stage31-autonomous-worker,project3-realtime-telegram-orchestration,project3-deliverable-validator,systematic-debugging,hermes-agent-skill-authoring}"
