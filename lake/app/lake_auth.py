"""Require DATA_GOV_LAKE_TOKEN (or sibling data-gov/var/lake_token) on /api/v1."""
...
def load_token() -> str | None:
    ...
    # lake/app → financial-data → GitHub/data-gov
    candidates.append(here.parents[2].parent / "data-gov" / "var" / "lake_token")
