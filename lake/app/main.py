...
GROUPS = {
    "pipeline_plugin": "finlake.pipeline",
    "web_plugin": "finlake.web",
    "inventory_plugin": "finlake.inventory",
}
...
def assemble(config: dict[str, Any]):
    return {
        "pipeline": _instantiate("finlake.pipeline", config["pipeline_plugin"], config),
        "web": _instantiate("finlake.web", config["web_plugin"], config),
        "inventory": _instantiate(
            "finlake.inventory", config["inventory_plugin"], config
        ),
    }
