...
Generated: 2026-05-01T17:48:16.850525+00:00
...
| dragon | Stage 1.3 Task 1.3.F Binance crypto comprehensive | busy | kept_running | market_data/crypto spot/perpetual/funding outputs |
...
| gamma | Stage 1.3 Task 1.3.F Binance crypto acceleration | busy | kept_running | market_data/crypto/perpetuals and funding_rates fetched on Gamma, then synced to Dragon/Omega |
| gamma->omega | Stage 1.3 canonical sync | deferred_busy | gamma_sync | Gamma completed macro/on-chain outputs copied to Omega |
| gamma->dragon | Stage 1.3 crypto acceleration sync | deferred_busy | gamma_crypto_to_dragon_sync | Gamma perpetual/funding outputs copied to Dragon so Dragon skips duplicated work |
| dragon->omega | Stage 1.3 canonical sync | deferred_busy | dragon_sync | Dragon crypto outputs copied to Omega after worker completion |
